    ...
    private generateEmbed(guild: Guild | null) {
        ...
        return util
            ...
            .addFields([
                ...
                {
                    name: "👥| Users",
                    value: `- **Members**: ${members.cache.filter((m) => !m.user.bot).size
                        }\n- **Bots**: ${members.cache.filter((m) => m.user.bot).size
                        }\n- **Online**: ${members.cache.filter(
                            (m) =>
                ...
                {
                    name: "📃 | Channels",
                    value: `- **Text**: ${channels.cache.filter(
                        (ch) => ch.type === ChannelType.GuildText
                    ).size
                        }\n- **Voice**: ${channels.cache.filter(
                ...
                },
                {
                    ...
                    value: `- **Animated**: ${emojis.cache.filter((e) => e.animated === true).size
                ...
                },
                {
                    ...
                    value: `- **Tier**: ${guild.premiumTier}\n- **Boosts**: ${guild.premiumSubscriptionCount
                        }\n- **Boosters**: ${members.cache.filter((m) => m.premiumSince !== null)
                            .size
                        }`,
                },
            ]);
