...
export class BotStaffCommand extends Command {
    ...
    async chatInputRun(interaction: Command.ChatInputCommandInteraction) {
        ...
        // TODO: Add more commands (Switch to "switch" upon adding more commands)
        ...
        if (options.getSubcommand() === "add") {
            ...
            if (bInteraction.customId === "accept") {
                ...
                if (bInteraction2.customId === "yes") {
                        ...
                        .setComponents(
                            util
                                ...
                                .setComponents(
                                    util
                                        .input()
                                        .setCustomId("bot_staff_description")
                    ...
                    dbStaff.description = mInteraction.fields.getTextInputValue(
